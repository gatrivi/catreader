...
# Prereq: CATTS API running (`uvicorn` on 59200). Funnel needs Tailscale Funnel enabled on the account.
# After this, set Vercel VITE_CATTS_URL to the printed HTTPS URL + VITE_CATTS_API_KEY=catts-local.
